...
- `IIT_Delhi_Project.ipynb`: Jupyter Notebook containing the end-to-end implementation (data processing, model training, and evaluation).
...
## 🎓 Acknowledgments
Developed at **IIT Delhi** and **IIT Patna**. Special thanks to OpenNeuro contributors for the datasets.
